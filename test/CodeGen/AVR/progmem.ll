...
for.body:                                         ; preds = %entry, %for.body
  ...
  %incdec.ptr = getelementptr inbounds i8 addrspace(1)* %x.addr.011, i16 1
  %0 = load i8 addrspace(1)* %x.addr.011
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %incdec.ptr = getelementptr inbounds i16 addrspace(1)* %x.addr.06, i16 1
  %0 = load i16 addrspace(1)* %x.addr.06
